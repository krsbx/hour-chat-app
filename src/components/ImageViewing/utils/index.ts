...
export const getImageTransform = (
  image: HourChat.Type.Dimensions | null,
  screen: HourChat.Type.Dimensions
) => {
...
export const getImageStyles = (
  ...
  const transform: { [name: string]: Animated.Value }[] =
...
export const getImageTranslate = (
  image: HourChat.Type.Dimensions,
  screen: HourChat.Type.Dimensions
): HourChat.Type.Position => {
...
export const getImageDimensionsByTranslate = (
  translate: HourChat.Type.Position,
  screen: HourChat.Type.Dimensions
): HourChat.Type.Dimensions => ({
  width: screen.width - translate.x * 2,
  height: screen.height - translate.y * 2,
});

export const getImageTranslateForScale = (
  currentTranslate: HourChat.Type.Position,
  targetScale: number,
  screen: HourChat.Type.Dimensions
): HourChat.Type.Position => {
